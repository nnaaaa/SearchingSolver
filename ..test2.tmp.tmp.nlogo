...
to setup
  ...
  set roads gis:load-dataset ".shp"
  set buildings gis:load-dataset "map/buildings-polygon.shp"
  set landcover gis:load-dataset "map/landcover-polygon.shp"
  set amenity gis:load-dataset "map/amenity_polygons-polygon.shp"
  ...
  gis:set-world-envelope (gis:envelope-of amenity)


  gis:set-drawing-color 25  gis:fill roads 1.0

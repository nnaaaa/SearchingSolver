...
to import-scenes
  if map-type = "Tokyo_Japan"[
    set waters gis:load-dataset "/1/water_areas-polygon.shp"
  ...
  if map-type = "Kyiv_Ukraine"[
    set waters gis:load-dataset "roadMap/5/water_areas-polygon.shp"
    set landcover gis:load-dataset "roadMap/5/landcover-polygon.shp"
    set amenity gis:load-dataset "roadMap/5/amenity_polygons-polygon.shp"
  ]
...
to import-buildings
  ...
  if map-type = "Kyiv_Ukraine"[
    set buildings gis:load-dataset "roadMap/5/buildings-polygon.shp"
  ]
...
to import-roads
  ...
  if map-type = "Kyiv_Ukraine"[
    set roads gis:load-dataset "roadMap/5/roads-line.shp"
  ]

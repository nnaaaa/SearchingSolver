      ...
      while [not empty? frontier] [
        ...
        if current-vertice = destination [
          ...
          while [current-vertice != root] [
            ...
            ;set link along path to another color
            ask link [who] of current-vertice [who] of first path  [set color gray set thickness 0.3]
          ]
          set path fput root path
          stop
        ]
      ...
      while [not empty? frontier] [
        ...
        if current-vertice = destination [
          ...
          while [current-vertice != root] [
            ...
            ;set link along path to another color
            ask link [who] of current-vertice [who] of first path  [set color blue set thickness 0.3]
          ]
          set path fput root path
          stop
        ]
